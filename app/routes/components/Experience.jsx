...
export default function Experience(){
   ...
   const experiences= [
    ...
    {id: 1, name:"Orange County Superior Court",position: "Software Engineer Intern", skills: "Typescript, Python, FastAPI, React ", startdate:"May 31, 2024", enddate:"Present", src:"/occourt.jpeg"},
    {id: 2, name:"California State University, Fullerton",position: "Graduate Student Assistant", skills: "GraphQL, Accounting, Automation ", startdate:"December 25, 2023", enddate:"May 15, 2024",src:"/csuf.png"},
    ...
    {id:4, name:"Accenture",position: "Software Engineer", skills: "React, PostgreSQL, API Design", startdate:"October 15, 2020", enddate:"July 4, 2022",src:"/Accenture.jpeg"},
    {id:5, name:"Tech Mahindra",position: "Software Intern", skills: "Neo4j, Python, Unity, React", startdate:"November 19, 2019", enddate:"April 17, 2020",src:"/techmahindra.jpeg"},
